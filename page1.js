const PAGE1 = (() => {
  ...
  function renderRegionCards(){
    ...
    DATA.hospitals.forEach(h=>{const z=h.zone||'Central';total[z]=(total[z]||0)+1;if(h.activeStatus==='Active')active[z]=(active[z]||0)+1;});
    zones.forEach(z=>{
  ...
  function runRecommendations(){
    ...
    if(!recs.length){el.innerHTML=`<div style="background:var(--amber-lt);border-radius:8px;padding:10px 14px;font-size:13px;color:var(--amber);">No historical cases found. Try fewer filters.</div>`;return;}
